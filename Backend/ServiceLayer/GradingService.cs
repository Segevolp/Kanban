...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        {
            return wrapperService.userService.Register(email, password);
        }


        /// <summary>
        ///  This method logs in an existing user.F
        /// </summary>
        ...
        {
            return wrapperService.userService.Login(email, password);
        }
        ...
        {
            return wrapperService.userService.Logout(email);
        }
        ...
        {
            return wrapperService.boardService.LimitColumn(email, boardName, columnOrdinal, limit);
        }
        ...
        {
            return wrapperService.boardService.GetColumnLimit(email, boardName, columnOrdinal);
        }
        ...
        {
            return wrapperService.boardService.GetColumnName(email, boardName, columnOrdinal);
        }
        ...
        {
            return wrapperService.taskService.AddTask(email, boardName, title, description, dueDate);
        }
        ...
        {
            return wrapperService.taskService.UpdateTaskDueDate(email, boardName, columnOrdinal, taskId, dueDate);
        }
        ...
        {
            return wrapperService.taskService.UpdateTaskTitle(email, boardName, columnOrdinal, taskId, title);
        }
        ...
        {
            return wrapperService.taskService.UpdateTaskDescription(email, boardName, columnOrdinal, taskId, description);
        }
        ...
        {
            return wrapperService.taskService.AdvanceTask(email, boardName, columnOrdinal, taskId);
        }
        ...
        {
            return wrapperService.boardService.GetColumn(email, boardName, columnOrdinal);
        }
        ...
        {
            return wrapperService.boardService.CreateBoard(email, name);
        }
        ...
        {
            return wrapperService.boardService.DeleteBoard(email, name);
        }
        ...
        {
            return wrapperService.userService.InProgressTasks(email);
        }
    }
}
